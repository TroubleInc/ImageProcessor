...
public class MedianFiltering extends ImageFilter{
	
	public String toString(){
		return "Median Filter N9";
	}
			...
			for(int j = 0; j < grey[i].length; j++){
				...
				if(i >= 1 && j >= 1){//9
					...
					if(grey[i-1][j-1] < el1){
						...
						el2 = el1;
						el1 = grey[i-1][j-1];
					} else if(grey[i-1][j-1] < el2){
						el5 = el4;
						el4 = el3;
						el3 = el2;
						el2 = grey[i-1][j-1];
					} else if(grey[i-1][j-1] < el3){
						el5 = el4;
						el4 = el3;
						el3 = grey[i-1][j-1];
					} else if(grey[i-1][j-1] < el4){
						el5 = el4;
						el4 = grey[i-1][j-1];
					} else if(grey[i-1][j-1] < el5){
						el5 = grey[i-1][j-1];
					}
				}
				
				if(i < grey.length - 1 && j >= 1){//9
					count++;
					if(grey[i+1][j-1] < el1){
						el5 = el4;
						el4 = el3;
				...
				if(i < grey.length - 1 && j < grey[0].length - 1){//9
					count++;
					if(grey[i+1][j+1] < el1){
						el5 = el4;
						el4 = el3;
